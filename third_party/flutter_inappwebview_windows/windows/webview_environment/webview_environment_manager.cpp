...
namespace flutter_inappwebview_plugin
{
  ...
  {
    NativeLog("WebViewEnvironmentManager ctor start");
    ...
    NativeLog("WebViewEnvironmentManager ctor end");
  }
  ...
  {
    NativeLog("WebViewEnvironmentManager::createWebViewEnvironment start");
    ...
    webViewEnvironment->create(std::move(settings),
      ...
      {
        NativeLog(std::string("WebViewEnvironmentManager::createWebViewEnvironment result=") + std::to_string(errorCode));
  ...
  {
    NativeLog("WebViewEnvironmentManager::createOrGetDefaultWebViewEnvironment start");
    if (defaultEnvironment_) {
      if (completionHandler) {
        NativeLog("WebViewEnvironmentManager::createOrGetDefaultWebViewEnvironment reuse");
    ...
    defaultEnvironment_->create(nullptr, [this, completionHandler](HRESULT errorCode)
      {
        NativeLog(std::string("WebViewEnvironmentManager::default create result=") + std::to_string(errorCode));
        if (succeededOrLog(errorCode)) {
          if (completionHandler) {
            completionHandler(defaultEnvironment_.get());
          }
